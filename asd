...
local library = {
	...
	colors = {
		...
		sectionBackground = Color3.fromRGB(0, 162, 255),
		...
		tabText = Color3.fromRGB(0, 162, 255)
	},
	gui_parent = (function()
...
function library:CreateWindow(options, ...)
	...
	function windowFunctions:CreateTab(options, ...)
		...
		function tabFunctions:CreateSection(options, ...)
			...
			function sectionFunctions:AddColorpicker(options, ...)
				...
				randomColorInner.Image = "rbxassetid://12305666125"
	...
	function windowFunctions:CreateDesigner(options, ...)
		...
		local daaata = {{"AddTextbox", "__Designer.Textbox.ImageAssetID", backgroundsection, {
			Name = "Image Asset ID",
			Placeholder = "rbxassetid://12305884811",
			Flag = "__Designer.Background.ImageAssetID",
			Value = "rbxassetid://12305884811",
