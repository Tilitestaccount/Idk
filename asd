...
local PresetColor = Color3.fromRGB(133, 0, 142)
...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	PresetColor = mainclr or Color3.fromRGB(133, 0, 142)
	local fs = false
	...
	MainFrame.BackgroundColor3 = Color3.fromRGB(133, 0, 142)
	...
	LeftFrame.BackgroundColor3 = Color3.fromRGB(133, 0, 142)
